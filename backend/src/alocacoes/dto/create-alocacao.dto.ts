...
export class CreateAlocacaoDto {
  ...
  // Include the monthly allocations directly or as a nested DTO
  // For simplicity, Prisma schema has them as direct fields. If they were a separate related table, a nested DTO would be better.
  @IsNumber()
  @IsOptional()
  @Min(0)
  mes01?: number;
  ...
  // totalAlocado will be calculated in the service, not provided by client
}
